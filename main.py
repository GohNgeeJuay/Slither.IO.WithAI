...
def draw_snake(snake: Snake):
    ...
    for index, block in enumerate(snake.body):
        ...
        if index == 0: #if it is the head, create head object
            ...
            screen.blit(snake.head,snakeRect)
